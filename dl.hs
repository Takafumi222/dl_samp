...
tbox2 = [
  (AtomicConcept "Property'") `CEQ` (thing `AND`
                                     ( ANY isPossessedOf
                                       ((AtomicConcept "male'") `AND` (AtomicConcept "female`")))) :: TBoxStatement ,
  (AtomicConcept "Murderer'") `CEQ` (((AtomicConcept "male'") `AND` (AtomicConcept "female`")) `AND`
                                     ( SOME killed
                                       ((AtomicConcept "male'") `AND` (AtomicConcept "female`")))) :: TBoxStatement ,
  (AtomicConcept "Thief'") `CEQ` ( ((AtomicConcept "male'") `AND` (AtomicConcept "female`")) `AND`
                                   ( SOME stole
                                     (AtomicConcept "Property'"))) :: TBoxStatement ,
  (AtomicConcept "Human'") `CEQ` ((AtomicConcept "male'") `AND` (AtomicConcept "female`")) :: TBoxStatement
  ]
